%Experiment 2 - Accuracy of Depth measurement as a function of distance in
%ambient sunlight
% The experiment was conducted on the 14th of December 2016
% The experiment was conducted for ambient light conditions varying from 22
% - 92 LUx ( Ambient Sunlight) 
...
% a scale. 
d1 = pcread('Ambdist_50.ply');
d2 = pcread('Ambdist_100.ply');
d3 = pcread('Ambdist_150.ply');
d4 = pcread('Ambdist_200.ply');
d5 = pcread('Ambdist_250.ply');
d6 = pcread('Ambdist_300.ply');
d7 = pcread('Ambdist_350.ply');
d8 = pcread('Ambdist_380.ply');
